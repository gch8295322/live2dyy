...
function loadWidget(config) {
	...
	(function registerEventListener() {
		...
		/*document.querySelector("#waifu-tool .fa-info-circle").addEventListener("click", () => {
			open("https://blognas.hwb0307.com/linux/docker/1165");
		});*/
		...
		fetch(waifuPath)
			...
			.then(result => {
				...
				$("#live2d").mousedown(function(e) {
				        if(e.which==3){
				        showMessage("<div style=\"text-align:center\">秘密通道<br/><a href=\"javascript:aplayer_panel_toggle();\">音乐播放器</a><br/><a href=\"https://github.com/gch8295322/live2dyy/\" target=\"_blank\">Github</a><br/><a href=\"https://chevereto.gyc0219.com/\" target=\"_blank\">图床</a><br/><a href=\"https://github.com/gch8295322\" target=\"_blank\">github主页</a><br/><a href=\"https://space.bilibili.com/8071049\" target=\"_blank\">b站主页</a></div>",4000,10);
						}
				});
